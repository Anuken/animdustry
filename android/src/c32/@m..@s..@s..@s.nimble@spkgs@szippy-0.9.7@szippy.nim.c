...
{nimErr_ = nimErrorFlag();
	...
	case ((tyEnum_CompressedDataFormat__hW3Jjtknic3hfPFuiaDRPw) 0):
	{
		...
		LA12_: ;
		{
			...
			T17_ = T18_;
			if (!(T17_)) goto LA20_;
			T17_ = ((NU8)((NU8)((NU8)(src_2[((NI) 0)]) >> (NU32)(((NI) 4)))) <= (NU8)(((NU8) 7)));
			LA20_: ;
			T16_ = T17_;
			if (!(T16_)) goto LA21_;
	...
	case ((tyEnum_CompressedDataFormat__hW3Jjtknic3hfPFuiaDRPw) 1):
	{
		...
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		checksum = (NU32)((NU32)((NU32)((NU32)((NU32)(((NU32) (src_2[(NI)(len - ((NI) 4))]))) << (NU32)(((NI) 24))) | (NU32)((NU32)(((NU32) (src_2[(NI)(len - ((NI) 3))]))) << (NU32)(((NI) 16)))) | (NU32)((NU32)(((NU32) (src_2[(NI)(len - ((NI) 2))]))) << (NU32)(((NI) 8)))) | ((NU32) (src_2[(NI)(len - ((NI) 1))])));
		{
			NU32 T54_;
...
{nimErr_ = nimErrorFlag();
	...
	case ((tyEnum_CompressedDataFormat__hW3Jjtknic3hfPFuiaDRPw) 2):
	{
		...
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		isize = len;
		nimAddCharV1((&result), ((NIM_CHAR) ((NU32)((NU32)((NU32)(checksum) >> (NU32)(((NI) 0))) & ((NU32) 255)))));
		nimAddCharV1((&result), ((NIM_CHAR) ((NU32)((NU32)((NU32)(checksum) >> (NU32)(((NI) 8))) & ((NU32) 255)))));
		nimAddCharV1((&result), ((NIM_CHAR) ((NU32)((NU32)((NU32)(checksum) >> (NU32)(((NI) 16))) & ((NU32) 255)))));
		nimAddCharV1((&result), ((NIM_CHAR) ((NU32)((NU32)((NU32)(checksum) >> (NU32)(((NI) 24))) & ((NU32) 255)))));
		nimAddCharV1((&result), ((NIM_CHAR) ((NI)((NI)((NI32)(isize) >> (NU32)(((NI) 0))) & ((NI) 255)))));
		nimAddCharV1((&result), ((NIM_CHAR) ((NI)((NI)((NI32)(isize) >> (NU32)(((NI) 8))) & ((NI) 255)))));
		nimAddCharV1((&result), ((NIM_CHAR) ((NI)((NI)((NI32)(isize) >> (NU32)(((NI) 16))) & ((NI) 255)))));
		nimAddCharV1((&result), ((NIM_CHAR) ((NI)((NI)((NI32)(isize) >> (NU32)(((NI) 24))) & ((NI) 255)))));
	}
	break;
	case ((tyEnum_CompressedDataFormat__hW3Jjtknic3hfPFuiaDRPw) 1):
	{
		...
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		nimAddCharV1((&result), ((NIM_CHAR) ((NU32)((NU32)((NU32)(checksum_2) >> (NU32)(((NI) 24))) & ((NU32) 255)))));
		nimAddCharV1((&result), ((NIM_CHAR) ((NU32)((NU32)((NU32)(checksum_2) >> (NU32)(((NI) 16))) & ((NU32) 255)))));
		nimAddCharV1((&result), ((NIM_CHAR) ((NU32)((NU32)((NU32)(checksum_2) >> (NU32)(((NI) 8))) & ((NU32) 255)))));
		nimAddCharV1((&result), ((NIM_CHAR) ((NU32)((NU32)((NU32)(checksum_2) >> (NU32)(((NI) 0))) & ((NU32) 255)))));
	}
	break;
	case ((tyEnum_CompressedDataFormat__hW3Jjtknic3hfPFuiaDRPw) 3):
	{
