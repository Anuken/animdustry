	...
	LA3_: ;
	{
		...
		i = ((NI) 0);
		{
			while (1) {
				...
				LA14_: ;
				colontmpD__2 = substr__system_6602(s, i, (NI)(j - ((NI) 1)));
...
appendString((&result), by);
		...
		colontmpD_ = substr__system_6614(s, i);
	...
	LA6_: ;
	{
		...
		i_2 = ((NI) 0);
		{
			while (1) {
				...
				LA27_: ;
				colontmpD__4 = substr__system_6602(s, i_2, (NI)(j_2 - ((NI) 1)));
...
appendString((&result), by);
		...
		colontmpD__3 = substr__system_6614(s, i_2);
