	...
	s2_2 = s2;
	{
		while (1) {
			...
			x = (NU64)(T3_ ^ T4_);
			{
				...
				if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
				result += (NI)((NI32)(matchingBits) >> (NU32)(((NI) 3)));
				goto BeforeRet_;
			}
			LA7_: ;
			s2_2 += ((NI) 8);
...
{nimErr_ = nimErrorFlag();
	...
	shift = ((NI) 24);
	{
		while (1) {
			...
			LA4_: ;
			if (!T3_) goto LA2;
			tableSize = (NI)((NU32)(tableSize) << (NU32)(((NI) 1)));
			shift -= ((NI) 1);
		} LA2: ;
	}
	zeroMem__system_1706(((void*) ((&compressTable[(((NI) 0))- 0]))), ((NI) ((NI)(tableSize * ((NI) 2)))));
	{
		...
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		nextHash = (NU32)((NU32)((NU32)((NU32)(T9_) * (NU32)(((NU32) 506832829)))) >> (NU32)(shift));
		{
			while (1) {
				NI skipBytes;
				NI nextIp;
				...
				candidate = (NI)0;
				{
					while (1) {
						...
						ip = nextIp;
						h = nextHash;
						bytesBetweenHashLookups = (NI)((NI32)(skipBytes) >> (NU32)(((NI) 5)));
						skipBytes += ((NI) 1);
						...
						if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
						nextHash = (NU32)((NU32)((NU32)((NU32)(T33_) * (NU32)(((NU32) 506832829)))) >> (NU32)(shift));
				...
				candidateBytes = (NU32)0;
				{
					while (1) {
						...
						(*encoding).p->data[(NI)((*ep) + ((NI) 0))] = (NU16)((NU16)((NU16)((NU32)(lengthIndexX60gensym11_) << (NU32)(((NI) 8))) | distIndexX60gensym11_) | ((NU16) 32768));
