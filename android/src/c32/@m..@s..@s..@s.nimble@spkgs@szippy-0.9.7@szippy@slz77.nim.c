...
{nimErr_ = nimErrorFlag();
	...
	chain = newSeq__OOZfauZsrcZfauZbatch_560(((NI) 32768));
	{
		while (1) {
			...
			hash = (NU32)((NU32)((NU32)((NU32)(T34_) * (NU32)(((NU32) 506832829)))) >> (NU32)(((NI) 15)));
			...
			} LA35: ;
			{
				...
				(*encoding).p->data[(NI)((*ep) + ((NI) 0))] = (NU16)((NU16)((NU16)((NU32)(lengthIndexX60gensym20_) << (NU32)(((NI) 8))) | distIndexX60gensym20_) | ((NU16) 32768));
					...
					i_5 = ((NI) 1);
					{
						while (1) {
							...
							windowPos = ((NU16) ((NI)(pos & ((NI) 32767))));
							{
								...
								if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
								hash = (NU32)((NU32)((NU32)((NU32)(T96_) * (NU32)(((NU32) 506832829)))) >> (NU32)(((NI) 15)));
								chain.p->data[windowPos] = head.p->data[hash];
								head.p->data[hash] = windowPos;
							}
							LA94_: ;
