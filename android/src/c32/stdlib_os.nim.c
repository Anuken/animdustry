...
static N_INLINE(NIM_CHAR, X5BX5D___system_6176)(NimStringV2 s, NI i);
static N_INLINE(NIM_CHAR*, X5BX5D___system_6209)(NimStringV2* s, NI i);
...
{nimErr_ = nimErrorFlag();
	...
	if (!(T2_)) goto LA3_;
	T4_ = (NIM_CHAR)0;
	T4_ = X5BX5D___system_6176(tail, ((NI) 1));
	...
	if (!(T8_)) goto LA9_;
	T10_ = (NIM_CHAR*)0;
	T10_ = X5BX5D___system_6209(result, ((NI) 1));
...
{nimErr_ = nimErrorFlag();
	...
	eqsink___system_2598((&(*e).Sup.Sup.message), T2_);
	{
		if (!(((NI) 0) < additionalInfo.len)) goto LA5_;
		{
			...
			if (!(T9_)) goto LA10_;
			T11_ = (NIM_CHAR*)0;
			T11_ = X5BX5D___system_6209((&(*e).Sup.Sup.message), ((NI) 1));
			T9_ = !(((NU8)((*T11_)) == (NU8)(10)));
			LA10_: ;
			if (!T9_) goto LA12_;
...
{nimErr_ = nimErrorFlag();
			...
			while (1) {
				...
				i = res;
				{
					...
					LA10_: ;
					{
						...
						colontmpD_ = substr__system_6602(dir, ((NI) 0), (NI)(i - ((NI) 1)));
						T14_ = (NIM_BOOL)0;
	...
	}
	{
		...
		if (!(T19_)) goto LA22_;
		T23_ = (NIM_CHAR)0;
		T23_ = X5BX5D___system_6176(dir, ((NI) 1));
