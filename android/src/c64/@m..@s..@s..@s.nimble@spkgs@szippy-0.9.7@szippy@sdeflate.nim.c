...
N_LIB_PRIVATE N_NIMCALL(void, huffmanCodes__OOZOOZOOZOnimbleZpkgsZzippy4548O57O55ZzippyZdeflate_18)(NU16* frequencies, NI frequenciesLen_0, NI minCodes, NI codeLengthLimit, tyTuple__g72oAI9bUatEQoES4rNovMg* Result);
	...
	nimZeroMem((void*)nextCode, sizeof(tyArray__C4LXewwYvv4lHcEgVwRSnQ));
	{
		...
		res = ((NI) 1);
		{
			while (1) {
				...
				i_12 = res;
				nextCode[(i_12)- 0] = (NU16)((NU64)((NU16)((NU16)(nextCode[((NI)(i_12 - ((NI) 1)))- 0]) + (NU16)(((NU16) (histogram[((NI)(i_12 - ((NI) 1)))- 0]))))) << (NU64)(((NI) 1)));
				res += ((NI) 1);
			} LA90: ;
		}
	}
			...
			while (1) {
				...
				blockNum_2 = i_2;
				{
					...
					nimZeroMem((void*)(&colontmp_), sizeof(tyTuple__g72oAI9bUatEQoES4rNovMg));
					{
						...
						LA47_: ;
						{
							huffmanCodes__OOZOOZOOZOnimbleZpkgsZzippy4548O57O55ZzippyZdeflate_18(metadata.litLenFreq, 286, ((NI) 257), ((NI) 15), (&colontmp_));
							if (NIM_UNLIKELY(*nimErr_)) goto LA24_;
						}
						LA45_: ;
					}
					...
					nimZeroMem((void*)(&colontmp__2), sizeof(tyTuple__g72oAI9bUatEQoES4rNovMg));
					{
						...
						LA55_: ;
						{
							huffmanCodes__OOZOOZOOZOnimbleZpkgsZzippy4548O57O55ZzippyZdeflate_18(metadata.distanceFreq, 30, ((NI) 2), ((NI) 15), (&colontmp__2));
							if (NIM_UNLIKELY(*nimErr_)) goto LA24_;
						}
						LA53_: ;
					}
					...
					LA60_: ;
					{
						...
						nimZeroMem((void*)(&colontmp__3), sizeof(tyTuple__g72oAI9bUatEQoES4rNovMg));
						huffmanCodes__OOZOOZOOZOnimbleZpkgsZzippy4548O57O55ZzippyZdeflate_18(clFreq, 19, ((NI) 19), ((NI) 7), (&colontmp__3));
						if (NIM_UNLIKELY(*nimErr_)) goto LA24_;
						...
						encPos = (NI)0;
						{
							while (1) {
								if (!(encPos < encodingLen)) goto LA152;
								{
									...
									lengthIndex = (NU16)((NU16)((NU16)(value) >> (NU64)(((NI) 8))) & ((NU16) 127));
									...
									bitLen_2 = (NI)0;
									{
										...
										i_15 = ((NI) 0);
										{
											while (1) {
												...
												LA167_: ;
												buf_2 = (NU32)(buf_2 | (NU32)((NU64)(((NU32) (litLenCodes.p->data[src[srcPos]]))) << (NU64)(bitLen_2)));
												bitLen_2 += codeLength;
												srcPos += ((NI) 1);
												i_15 += ((NI) 1);
											} LA164: ;
