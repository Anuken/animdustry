		...
		i_4 = ((NI) 1);
		{
			while (1) {
				...
				i_3 = i_4;
				{
					...
					if (!((NU16)((NU16)((NU64)(((NU16) 1)) << (NU64)(i_3))) < (NU16)(histogram[(i_3)- 0]))) goto LA9_;
					T11_ = NIM_NIL;
		...
		i_6 = ((NI) 1);
		{
			while (1) {
				...
				code = (NU32)((NU32)(code) + (NU32)(((NU32) (histogram[(i_5)- 0]))));
				{
					...
					if (!(T17_)) goto LA18_;
					T17_ = ((NU32)((NU32)((NU64)(((NU32) 1)) << (NU64)(i_5))) <= (NU32)((NU32)((NU32)(code) - (NU32)(((NU32) 1)))));
					LA18_: ;
					if (!T17_) goto LA19_;
					T21_ = NIM_NIL;
				...
				LA19_: ;
				(*huffman).maxCodes[(i_5)- 0] = (NU32)((NU64)(code) << (NU64)((NI)(((NI) 16) - i_5)));
				code = (NU32)((NU64)(code) << (NU64)(((NI) 1)));
				k += histogram[(i_5)- 0];
				i_6 += ((NI) 1);
			} LA14: ;
		}
			...
			while (1) {
				...
				len = codeLengths[i_8];
				{
					...
					(*huffman).values[(symbolId)- 0] = ((NU16) (i_7));
					{
						...
						fast = (NU16)((NU16)((NU64)(((NU16) (len))) << (NU64)(((NI) 9))) | ((NU16) (i_7)));
						T33_ = (NU16)0;
...
{nimErr_ = nimErrorFlag();
	...
	codeLength = (NU16)0;
	{
		...
		codeLength = (NU16)((NU16)(fast) >> (NU64)(((NI) 9)));
