...
N_LIB_PRIVATE N_NIMCALL(void, initParams__OOZfauZsrcZfauZglobals_207)(tyObject_Vec2i__Vb00liq4ISM4Oc07yydBJQ size, NimStringV2 title, NIM_BOOL maximize, NIM_BOOL depth, NIM_BOOL undecorated, NIM_BOOL transparent, tyObject_Color__OSWJq3HNkIl1V7S3GsYvBg clearColor, tyObject_FauInitParams__Z0pthJcpoAihemqm26DYFg* Result) {
