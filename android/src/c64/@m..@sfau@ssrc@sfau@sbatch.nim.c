...
{nimErr_ = nimErrorFlag();
	...
	(*dest).blend.dst = (*src).blend.dst;
	{
		...
		nimRawDispose((*dest).shader, ((NI) 8));
	}
	LA4_: ;
	...
	{
		{
			...
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
			nimRawDispose((*dest)._kind_1.tex, ((NI) 8));
		}
		LA10_: ;
	}
	break;
	...
	{
		{
			...
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
			nimRawDispose((*dest)._kind_2.patch.texture, ((NI) 8));
		}
		LA16_: ;
	}
	break;
	...
	colontmp_ = ((NI) 0);
	{
		while (1) {
			...
			if (!(colontmp_ < T3_)) goto LA2;
			{
				...
				if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
				nimRawDispose((*dest).p->data[colontmp_].shader, ((NI) 8));
			}
			LA7_: ;
			...
			{
				{
					...
					if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
					nimRawDispose((*dest).p->data[colontmp_]._kind_1.tex, ((NI) 8));
				}
				LA13_: ;
			}
			break;
			...
			{
				{
					...
					if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
					nimRawDispose((*dest).p->data[colontmp_]._kind_2.patch.texture, ((NI) 8));
				}
				LA19_: ;
			}
			break;
...
{nimErr_ = nimErrorFlag();
	...
	}
	{
		...
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		nimRawDispose(colontmp_.shader, ((NI) 8));
	}
	LA47_: ;
	...
	{
		{
			...
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
			nimRawDispose(colontmp_._kind_1.tex, ((NI) 8));
		}
		LA53_: ;
	}
	break;
	...
	{
		{
			...
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
			nimRawDispose(colontmp_._kind_2.patch.texture, ((NI) 8));
		}
		LA59_: ;
	}
	break;
...
{nimErr_ = nimErrorFlag();
	...
	LA4_: ;
	{
		...
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		nimRawDispose((*dest).defaultShader, ((NI) 8));
	}
	LA9_: ;
	{
		NIM_BOOL T13_;
		...
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		nimRawDispose((*dest).lastShader, ((NI) 8));
	}
	LA14_: ;
	{
		NIM_BOOL T18_;
		...
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		nimRawDispose((*dest).lastTexture, ((NI) 8));
	}
	LA19_: ;
	{
		NIM_BOOL T23_;
